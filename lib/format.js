 ...
 * @return {Object}
 */function billing(a){return a=clone(a),!validate.isObject(a),a.hasOwnProperty("addressRequired")&&!1==a.addressRequired?{addressRequired:!1}:0==Object.keys(a).length?{addressRequired:!1}:{address:a}}/**
 * sender
 * @param {Object} sender
 * @return {Object}
